...
#A PAGE TO GET A NAME /get_name -->  /place_bet

# page to place bet /get_name  --> /show_flop

#SHOW FLOP
#   session variables dealer_hand, user_hand
suits = ['D', 'C', 'H', 'S']
...
#DUDE you didn't show us any loops.
# really don't want to code this w/o such construct
